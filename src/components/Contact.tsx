...
const Contact = () => {
  ...
  const { ref: contentRef, isIntersecting: contentInView } = useIntersectionObserver();
          ...
          <div className="space-y-8">
            <div>
              ...
              <div ref={contentRef} className={`group mb-8 ${isMobile ? 'lg:group' : ''}`}>
                <p className={`text-gray-500 text-lg leading-relaxed transition-opacity duration-300 ${
                  isMobile 
                ...
                <div>
                  ...
                  <p className={`text-gray-500 transition-opacity duration-300 ${
                    isMobile 
                      ? (contentInView ? 'opacity-100' : 'opacity-0') 
                      : 'opacity-0 group-hover:opacity-100'
                  }`}>hello@automationarchitech.com</p>
                </div>
              </div>
