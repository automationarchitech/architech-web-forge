      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            {/* Benefits */}
            <div className="group bg-gray-50 p-6 rounded-xl border border-gray-100">
              <h4 className="text-gray-900 font-medium mb-4">What to Expect:</h4>
              <div className="space-y-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                ...
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-4 h-4 text-gray-400" />
                  <span className="text-gray-600 text-sm">Free consultation call</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-4 h-4 text-gray-400" />
                  <span className="text-gray-600 text-sm">Custom solution proposal</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-xl p-8 border border-gray-100">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-gray-900 text-white py-3 px-6 rounded-lg font-light hover:bg-gray-800 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isSubmitting ? (
                  <>
