...
const Hero = () => {
  const { targetRef: descriptionRef, isIntersecting: isDescriptionVisible } = useIntersectionObserver();
  const { targetRef: servicesRef, isIntersecting: areServicesVisible } = useIntersectionObserver();
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="animate-fade-in">
          ...
          <div ref={descriptionRef} className="mb-12">
            <p className={`text-lg md:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed transition-opacity duration-500 ${
              isDescriptionVisible ? 'opacity-100' : 'opacity-0 md:opacity-100'
            } hover:opacity-100`}>
          ...
          <div ref={servicesRef} className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="group flex flex-col items-center p-8 hover:bg-gray-50 rounded-xl transition-all duration-300">
              ...
              <p className={`text-gray-500 text-center transition-opacity duration-500 ${
                areServicesVisible ? 'opacity-100' : 'opacity-0 md:opacity-100'
              } group-hover:opacity-100`}>Custom AI solutions tailored to your business needs</p>
            </div>
            ...
            <div className="group flex flex-col items-center p-8 hover:bg-gray-50 rounded-xl transition-all duration-300">
              ...
              <p className={`text-gray-500 text-center transition-opacity duration-500 ${
                areServicesVisible ? 'opacity-100' : 'opacity-0 md:opacity-100'
              } group-hover:opacity-100`}>Robust data processing and scraping solutions</p>
            </div>
            ...
            <div className="group flex flex-col items-center p-8 hover:bg-gray-50 rounded-xl transition-all duration-300">
              ...
              <p className={`text-gray-500 text-center transition-opacity duration-500 ${
                areServicesVisible ? 'opacity-100' : 'opacity-0 md:opacity-100'
              } group-hover:opacity-100`}>Seamless integration between your applications</p>
            </div>
          </div>
        </div>
      </div>
