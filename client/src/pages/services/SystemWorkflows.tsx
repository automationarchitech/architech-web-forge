...
const SystemWorkflows = () => {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description:
        "Eliminate manual tasks and reduce human error with intelligent automation.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Tailored automation solutions that fit your specific business processes.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-gray-600 leading-relaxed mb-8">
              Connect your applications seamlessly with intelligent automation
              and workflow orchestration. We build the bridges between your
              systems to create unifie business processes.
            </p>
