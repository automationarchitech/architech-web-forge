...
import LLMApplications from "./pages/services/LLMApplications";
...
import ConcurrentFunctionCalling from "./pages/ConcurrentFunctionCalling";
    ...
    <TooltipProvider>
      ...
      <HashRouter>
        ...
        <Routes>
          ...
          <Route path="/services/llm-applications" element={<LLMApplications />} />
          ...
          <Route path="/concurrent-function-calling" element={<ConcurrentFunctionCalling />} />
